...
axs[0].set_ylabel(r'$F_d(x)$', fontsize='x-large')
...
axs[1].set_ylabel(r'$F_d(G(z))$', fontsize='x-large')
...
axs[2].set_ylabel(r'$F_d(x)$', fontsize='x-large')
...
axs[3].set_ylabel(r'$F_d(G(z))$', fontsize='x-large')
