...
from src.models.sagan_architecture import Generator, MDiscriminators
from src.losses.gan1 import MDLoss as gan1_loss
from src.losses.lsgan import MDLoss as lsgan_loss
...
# make exp_folder
exp_folder = f'experiments/baseline/baseline_mheads/{args.exp_name}'
