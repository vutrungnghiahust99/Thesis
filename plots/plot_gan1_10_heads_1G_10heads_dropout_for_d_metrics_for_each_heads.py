...
exp1 = 'experiments/gan1_10_heads_1G_10heads_dropout_for_d/gan1_10_heads_1G_10heads_dropout_for_d_metrics_for_each_heads.csv'
...
plt.tight_layout()
plt.savefig('reports/gan1_10_heads_1G_10heads_dropout_for_d_metrics_for_each_heads.pdf')
