...
exp1 = 'rfgan_lossgan1_bagging0_augmentation1_5heads_usemaskD_sagan'
exp2 = 'rfgan_lossgan1_bagging1_augmentation1_5heads_usemaskD_sagan'
exp6 = 'experiments/baseline/baseline_hgan/baselinehgan_losshgan_5heads_augmentation1_sagan/baselinehgan_losshgan_5heads_augmentation1_sagan.csv'
...
plt.tight_layout()
plt.savefig('plots/sagan/rfgan_vs_baselines/augmentation1.pdf')
