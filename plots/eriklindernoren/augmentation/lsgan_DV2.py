...
exp1 = 'experiments/augmentation/lsgan_baseline/lsgan_baseline.csv'
exp2 = 'experiments/augmentation/lsgan_10_heads_1G_10heads_DV2/lsgan_10_heads_1G_10heads_DV2.csv'
exp3 = 'experiments/augmentation/lsgan_10_heads_1G_10heads_diff_data_for_heads_DV2/lsgan_10_heads_1G_10heads_diff_data_for_heads_DV2.csv'
# exp4 = 'experiments/augmentation/lsgan_1G_1big_head/lsgan_1G_1big_head.csv'

df1 = pd.read_csv(exp1)
df2 = pd.read_csv(exp2)
df3 = pd.read_csv(exp3)
# df4 = pd.read_csv(exp4)
n = min(df1.shape[0], df2.shape[0], df3.shape[0], 376 // 8)
df1 = df1.iloc[0:n, :]
df2 = df2.iloc[0:n, :]
df3 = df3.iloc[0:n, :]
# df4 = df4.iloc[0:n, :]
