...
n = min(df1.shape[0], df2.shape[0], df3.shape[0], df4.shape[0])
df1 = df1.iloc[0:n, :]
df2 = df2.iloc[0:n, :]
df3 = df3.iloc[0:n, :]
df4 = df4.iloc[0:n, :]
...
plt.savefig('reports/gan1_baseline__gan1_1G_1big_head__gan1_10_heads_1G_10heads__gan1_10_heads_1G_10heads_diff_data_for_heads.pdf')
